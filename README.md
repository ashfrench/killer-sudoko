...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img alt="Example Sudoku Grid - Source Wiki" src="./src/main/resources/images/example-sudoku-grid.png" style="display: block; margin-left: auto; margin-right: auto;"> | <img alt="Hard To Brute Force - Source Wiki" src="./src/main/resources/images/Sudoku_puzzle_hard_for_brute_force.svg.png" style="display: block; margin-left: auto; margin-right: auto;"> | <img alt="Example Sudoku Grid Brute Force - Source Wiki" src="./src/main/resources/images/Sudoku_solved_by_bactracking.gif" style="display: block; margin-left: auto; margin-right: auto;"> | <img alt="Example Solved Sudoku Grid - Source Wiki" src="./src/main/resources/images/solved_puzzle.svg" style="display: block; margin-left: auto; margin-right: auto;"> |
