...
object SudokuContextStore : ExtensionContext.Store, ExtensionContext.Store.CloseableResource {
    ...
    override fun <V : Any?> get(key: Any?, requiredType: Class<V>?) = sudokuMapStore[key] as V

    override fun <K : Any?, V : Any?> getOrComputeIfAbsent(key: K, defaultCreator: Function<K, V>) =
